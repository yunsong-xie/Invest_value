...
if __name__ == '__main__0':
    ...
    data_merge_x as (
        ...
        on ty0.symbol = ty1.symbol and ty0.symbol = ty2.symbol
        and ty0.rdq = ty1.rdq and ty0.rdq = ty2.rdq
    ), 
    data_merge_xy as (
    ...
    keys_front = ['symbol', 'datafqtr', 'marketcap_p', 'marketcap_0', 'marketcap_1']
